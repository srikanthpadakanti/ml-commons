...
import org.opensearch.ml.common.connector.functions.postprocess.JurassicPostProcessFunction;
...
public class MLPostProcessFunction {
    ...
    public static final String BEDROCK_AI21_JURASSIC = "connector.post_process.bedrock.ai21_jurassic";
    ...
    static {
        ...
        JurassicPostProcessFunction jurassicPostProcessFunction = new JurassicPostProcessFunction();
        ...
        JSON_PATH_EXPRESSION.put(BEDROCK_AI21_JURASSIC, "$.completions[0].data.text");
        ...
        POST_PROCESS_FUNCTIONS.put(BEDROCK_AI21_JURASSIC, jurassicPostProcessFunction);
    }
